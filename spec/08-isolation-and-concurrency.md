...
| Patch apply conflict | Two isolated Implementers touched the same file | `git apply` failure at merge | Orchestrator re-partitions and re-dispatches sequentially. Do not retry the same partition. |
