...
Two rounds of such revisions have occurred. The first was the owner-authorized `README.md` redesign
...
second was the owner-authorized defect-repair round recorded below.

```text
pwsh -File scripts/repair-evidence-byte-integrity.ps1
  FAIL: Exact=950 Recoverable=0 Unrecoverable=5 Missing=0 Invalid=20
        Ambiguous=0 Written=0                                                       exit 1
```

The twenty `invalid` paths are exactly the authorized change set, and `950 + 20 = 970` — the
